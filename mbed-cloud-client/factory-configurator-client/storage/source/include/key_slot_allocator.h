...
/*===========================Generatl Purpose APIs===========================================*/
    ...
    */
    ...
    /** Loads an external items resides in secure element into a new table entry.
    *
 ...
 * @item_location[IN] The location that the item should be stored to. Can be PSA or Secure Element
